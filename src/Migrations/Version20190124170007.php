 ...
 */
final class Version20190124170007 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contract ADD factory VARCHAR(255) NOT NULL, ADD position VARCHAR(255) NOT NULL, ADD contract_type VARCHAR(255) NOT NULL, ADD employee VARCHAR(255) NOT NULL, DROP factory_id, DROP position_id, DROP contract_type_id, DROP employee_id');
        $this->addSql('ALTER TABLE employee ADD contracts VARCHAR(255) NOT NULL');
    }
